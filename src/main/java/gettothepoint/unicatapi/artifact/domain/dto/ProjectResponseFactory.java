...
public class ProjectResponseFactory {
    ...
    public ProjectResponse fromEntity(Project project) {
        return ProjectResponse.builder()
                ...
                .thumbnailUrl(project.getThumbnailUrl() != null ? fileService.load(project.getThumbnailUrl()).toString() : null)
                .titleUrl(project.getTitleImageKey() != null ? fileService.load(project.getTitleImageKey()).toString() : null)
                .artifactUrl(project.getArtifactKey() != null ? fileService.load(project.getArtifactKey()).toString() : null)
