...
public class JWTUtil {
    ...
    @Value("${ai-news.jwt.expiration}")
    private Long jwtExpiredTime;

    @Value("${ai-news.jwt.cookie.maxAge}")
    private int maxAge;

    @Value("${ai-news.jwt.cookie.sameSite}")
    private String sameSite;

    @Value("${ai-news.jwt.cookie.httpOnly}")
    private boolean httpOnly;

    @Value("${ai-news.jwt.cookie.secure}")
    private boolean secure;

    @Value("${ai-news.jwt.cookie.domain}")
    private String domain;

    @Value("${ai-news.jwt.cookie.path}")
    private String path;

    @Value("${ai-news.jwt.cookie.name}")
    private String cookieName;

    public JWTUtil(
            ClaimsCache claimsCache,
            @Value("${ai-news.jwt.secret}") String secret
                   ) {
